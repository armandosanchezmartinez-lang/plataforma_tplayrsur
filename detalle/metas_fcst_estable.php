...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box}
        ...
        .semaforo-wrap{overflow-x:auto;border:1px solid #e2e8f0;border-radius:16px;background:rgba(255,255,255,.72)}
        .semaforo-table{border-collapse:collapse;width:100%;min-width:900px;font-size:.72rem}
