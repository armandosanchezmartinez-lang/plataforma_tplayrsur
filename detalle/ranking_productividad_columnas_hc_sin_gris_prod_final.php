        ...
        <table id="rankingTable">
            <thead>
                <tr>
                    <th class="center">#</th>
                    <th>Distrito</th>
                    <th><?= h($entity_label) ?></th>
                    <th class="num sortable" data-key="ins_sem_base">INS<br><?= h($label_col_base) ?> <span class="sort-icon">↕</span></th>
                    <th class="num sortable" data-key="ins_sem_actual">INS<br><?= h($label_col_actual) ?> <span class="sort-icon">↕</span></th>
                    <th class="num sortable" data-key="dif">Dif. <span class="sort-icon">↕</span></th>
                    <th class="center sortable" data-key="pct_dif">% Dif. <span class="sort-icon">↕</span></th>
                    <th class="num sortable" data-key="hc_activo_base">HC Activo<br><?= h($label_col_base) ?> <span class="sort-icon">↕</span></th>
                    <th class="num sortable" data-key="hc_activo_actual">HC Activo<br><?= h($label_col_actual) ?> <span class="sort-icon">↕</span></th>
                    <th class="num sortable" data-key="hc_con_ins_base">HC con INS<br><?= h($label_col_base) ?> <span class="sort-icon">↕</span></th>
                    <th class="num sortable" data-key="hc_con_ins_actual">HC con INS<br><?= h($label_col_actual) ?> <span class="sort-icon">↕</span></th>
                    <th class="num sortable" data-key="hc_sin_venta_base">HC sin INS<br><?= h($label_col_base) ?> <span class="sort-icon">↕</span></th>
                    <th class="num sortable" data-key="hc_sin_venta_actual">HC sin INS<br><?= h($label_col_actual) ?> <span class="sort-icon">↕</span></th>
                    <th class="num sortable" data-key="vacante_base">HC Vacante<br><?= h($label_col_base) ?> <span class="sort-icon">↕</span></th>
                    <th class="num sortable" data-key="hc_total_base">HC Total<br><?= h($label_col_base) ?> <span class="sort-icon">↕</span></th>
                    <th class="num sortable" data-key="vacante_actual">HC Vacante<br><?= h($label_col_actual) ?> <span class="sort-icon">↕</span></th>
                    <th class="num sortable" data-key="hc_total_actual">HC Total<br><?= h($label_col_actual) ?> <span class="sort-icon">↕</span></th>
                    <th class="center sortable" data-key="prod_base">Prod.<br><?= h($label_col_base) ?> <span class="sort-icon">↕</span></th>
                    <th class="center sortable" data-key="prod_actual">Prod.<br><?= h($label_col_actual) ?> <span class="sort-icon">↕</span></th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr class="data-row <?= $href ? 'clickable' : '' ?>" data-href="<?= h($href) ?>" data-district="<?= h($r['distrito']) ?>"
                    ...
                    <td class="num"><?= fmt_num($r['vacante_base']) ?></td>
                    <td class="num"><?= fmt_num($r['hc_total_base']) ?></td>
                    <td class="num"><?= fmt_num($r['vacante_actual']) ?></td>
                    <td class="num"><?= fmt_num($r['hc_total_actual']) ?></td>
                ...
                <tr class="total-row" id="totalRow">
                    ...
                    <td class="num" data-total-key="vacante_base"><?= fmt_num($tot['vacante_base']) ?></td>
                    <td class="num" data-total-key="hc_total_base"><?= fmt_num($tot['hc_total_base']) ?></td>
                    <td class="num" data-total-key="vacante_actual"><?= fmt_num($tot['vacante_actual']) ?></td>
                    <td class="num" data-total-key="hc_total_actual"><?= fmt_num($tot['hc_total_actual']) ?></td>
