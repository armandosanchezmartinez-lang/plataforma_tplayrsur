...
function plan_operativo_por_id($conexion,$anio,$semana,$id_pos,$meta){
...
foreach($grupos as $g){
    ...
    $plan=plan_operativo_por_id($conexion,$anio,$semana,$idg,$meta);
