...
<section class="topbar">
    ...
    <div class="week-nav">
        ...
        ?>
            ...
            <form class="month-day-filter compact calendar-mode" method="get">
                ...
                <input type="date" name="fecha_inicio"
                       min="<?= h(sprintf('%04d-%02d-01', $anio_mes_actual, $mes_actual)) ?>"
                       max="<?= h(sprintf('%04d-%02d-%02d', $anio_mes_actual, $mes_actual, $ultimo_dia_actual)) ?>"
                       value="<?= h($fecha_inicio_actual) ?>">

                <label>Hasta:</label>
                <input type="date" name="fecha_fin"
                       min="<?= h(sprintf('%04d-%02d-01', $anio_mes_actual, $mes_actual)) ?>"
                       max="<?= h(sprintf('%04d-%02d-%02d', $anio_mes_actual, $mes_actual, $ultimo_dia_actual)) ?>"
                       value="<?= h($fecha_fin_actual) ?>">

                <button type="submit">Aplicar</button>

                <a class="quick-range" href="?<?= qs(array_merge($_GET, ['periodo'=>'mensual','rango_mode'=>'mtd','dia_inicio'=>1,'dia_fin'=>$dia_default_mensual])) ?>">MTD día vencido</a>
