...
<a href="metas_fcst_captura.php" class="nav-item"><span class="nav-icon">🎯</span>Captura FCST</a>
...
(function(){
    ...
    serieReal.forEach((v,i)=>{
        ...
        grad.addColorStop(0,'#FF00B8');
        grad.addColorStop(1,'rgba(122,43,255,.22)');
        ctx.fillStyle=grad;
