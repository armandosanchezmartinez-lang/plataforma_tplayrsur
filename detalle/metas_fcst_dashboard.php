...
<div class="grid"><section class="card"><div class="title"><h2>Semáforo jerárquico · <?=h($scope['titulo'])?></h2><span>% cumplimiento vs META</span></div><div class="heat"><?php foreach($rows as $r): ?>
<a class="dcard <?=h($r['cm'])?>" href="metas_fcst_consulta.php?anio=<?=h($anio)?>&semana=<?=h($semana)?>&id_posicion=<?=urlencode($r['id_posicion'])?>" title="Consultar tablero de <?=h($r['distrito'])?>">
    <div class="name"><?=h($r['distrito'])?></div>
    <div class="pct"><?=h(fpct($r['pm']))?></div>
    <div class="risk"><?=h($r['riesgo'])?> · Ver tablero</div>
</a>
