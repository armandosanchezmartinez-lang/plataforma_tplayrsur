...
foreach ($vendedores as $vend) {
    ...
    if ($reai_total == 0 && $prod_actual_tmp < .70 && ($inst_actual == 0 || $inst_actual < $inst_base)) $total_riesgo++;
}
?>
<!DOCTYPE html>
<html lang="es">
        ...
        <table>
            ...
            <?php foreach ($vendedores as $vend):
                ...
                if ($reai_total > 0) {
                    ...
                    // Aunque exista caída vs período anterior, con productividad buena no se sugiere acción.
                    $estatus_txt = 'OK'; $estatus_cls = 'status-ok';
                } elseif ($inst_act == 0) {
                    $estatus_txt = 'Sin prod / Sugerir R'; $estatus_cls = 'status-risk';
                } elseif ($inst_act < $inst_base && $prod < .70) {
                    $estatus_txt = 'Sugerir R'; $estatus_cls = 'status-alert';
                } else {
                    $estatus_txt = 'OK'; $estatus_cls = 'status-ok';
                }
            ?>
