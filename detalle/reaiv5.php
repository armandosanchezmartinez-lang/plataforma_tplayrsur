...
foreach ($vendedores as $vend) {
    ...
    if ($reai_total == 0 && $prod_actual_tmp < .70 && ($inst_actual == 0 || $caida_pronunciada_tmp || $prod_actual_tmp < .40 || $caida_leve_tmp || ($prod_actual_tmp >= .40 && $prod_actual_tmp < .70))) $total_riesgo++;
}
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>REAI v3 — TOTALXPEDIENT</title>
    ...
    <div class="table-card">
        <table>
            ...
            <?php foreach ($vendedores as $vend):
                ...
                // - Productividad buena no requiere acción aunque exista caída vs período anterior.
                // - Leve: dif negativa leve o productividad amarilla => Aplicar R.
                // - Medio: productividad roja sin caída pronunciada => Aplicar E.
                // - Grave: dif negativa pronunciada, cero productividad o productividad roja con caída => Aplicar A.
